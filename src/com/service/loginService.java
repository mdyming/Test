...
public class loginService
{
	...
	public String login(String userName,String userPw,int userType)
	{
		...
		if(userType==2)//
		{
			String sql="from TXuesheng where xuehao=? and loginpw=? and del='no'";
			Object[] con={userName,userPw};
			List xueshengList=xueshengDAO.getHibernateTemplate().find(sql,con);
			...
			else
			{
				 WebContext ctx = WebContextFactory.get(); 
				 HttpSession session=ctx.getSession(); 
				 TXuesheng xuesheng=(TXuesheng)xueshengList.get(0);
