//注意第12行。也可以吧第45行的注释曲调看看
var kfguin="1020842508";
kfguin2="1020842508";
kfguin3="294803234";
ws="www.aaa.com"; 
companyname=""; 
wangwang="liu1983311"; 
welcomeword="高校填报志愿系统";
 type="1";

var online= new Array();
var urlroot = "/zhiyuan/img/qq/";
var tOut = -1;
var drag = false;
var g_safeNode = null;
lastScrollY = 0;
...
if(kfguin)
{
 ...
 rightDivHtml += kf_getPopupRightDivHtml(kfguin,ws);
  ...
  if(type==1 && kf_getCookie('hasshown')==0)
  {
      ...
      //window.setTimeout("kf_sleepShow()",2000);//注意这一句。可以吧注释去掉看看
  }
...
function kf_getPopupDivHtml(kfguin,reference,companyname,welcomeword)
{
    ...
    temp += ' <a onclick="kf_openChatWindow(1)" href="#" style="float:right;background-image: url('+urlroot+'btn_2.gif);margin: 0px;padding: 0px;border:0px;height: 21px;width: 69px;"></a> <a target="_blank" style="float:right; margin-right:5px;" href="http://amos.im.alisoft.com/msg.aw?v=2&uid='+wangwang+'&site=cntaobao&s=1&charset=utf-8" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid='+wangwang+'&site=cntaobao&s=1&charset=utf-8" alt="点击这里给我发消息" /></a> </div>';
...
{	
	...
	temp += '<div class="wpa_popup" style="width:111px; height:auto;" id="msn">';
  temp += '<div style=" width:110px; height:114px;  background-image:url('+urlroot+'kf_rig_3.gif); background-repeat:no-repeat; background-position:top left;cursor:hand" onclick="closeDiv()"></div>';
  temp += '<div style="background-image:url('+urlroot+'kf_rig_5.gif); width:110px; background-position:left top; background-repeat:repeat-y; padding-left:1px;">';
  temp += '<div style="background-image:url('+urlroot+'kf_rig_7.gif); background-position:left bottom; background-repeat:repeat-X; padding-left:0px; width:105px;">';
 
  temp += '<div style="padding-bottom:5px;padding-left:11px">QQ客服1:<A href="http://wpa.qq.com/msgrd?V=1&Uin='+kfguin2+'&Site=-&amp;Menu=no" target=_blank><br /> &nbsp;<IMG alt="message" src="http://wpa.qq.com/pa?p=1:'+kfguin2+':7" align=absMiddle border=0></A></div>';
  temp +=  '<div style="padding-bottom:5px;padding-left:11px">QQ客服2:<A href="http://wpa.qq.com/msgrd?V=1&Uin='+kfguin3+'&Site=-&amp;Menu=no" target=_blank><br /> &nbsp;<IMG alt="message" src="http://wpa.qq.com/pa?p=1:'+kfguin3+':7" align=absMiddle border=0></A></div>';
   
  temp +='</div></div><div style=" width:110px; height:35px; background-image:url('+urlroot+'kf_rig_9.gif); background-repeat:no-repeat; background-position:top left;"></div></div>';
  return temp;
}
...
{
	window.open('http://wpa.qq.com/msgrd?V=1&Uin='+kfguin+'&Site=-&amp;Menu=no', '_blank', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
	if(flag==1)
	{
		kf_hidekfpopup();
	}
...
{   
	...
	var position = parseInt(document.getElementById("rightDiv").style.top) + 70;
